...
import com.example.mymasjid.FromDaftarMasjidActivity;

import simple.example.daftarmasjid.R;

class FromDaftarMasjidActivity extends AppCompatActivity {
    ...
    final String[] tipeFavorite = {com.example.mymasjid.DaftarMasjid.Masjid, com.example.mymasjid.DaftarMasjid.Mushola};
    ...
    private void simpan() {
        if (isDataValid()) {
            com.example.mymasjid.DaftarMasjid tr = new com.example.mymasjid.DaftarMasjid();
